  ...
  var e = {
      ...
      320(e, t, n) {
        ...
        function y(e) {
          ...
          return (
            "descendant-or-self" ===
              (null === (t = N(e, "xpathAxis")) || void 0 === t
                ? void 0
                : t.textContent) && !!N(e, "anyKindTest")
          );
        }
        ...
        function b(e, t, n, r) {
          ...
          if (
            ...
            for (const o of e.childNodes) b(o, t, n, r);
          else if ("pathExpr" === s) {
            const o = e.childNodes.filter((e) => v(e, "stepExpr"));
            if (0 === o.length) throw new T();
            for (const e of o.slice(0, -1)) if (!y(e)) throw new T();
            b(o[o.length - 1], t, n, r);
          } else if ("stepExpr" === s) {
            const a =
              null === (o = N(e, "xpathAxis")) || void 0 === o
                ? void 0
                : o.textContent;
        ...
        function w(e, t) {
          ...
          if (s) {
            const e =
              null === (r = N(s, "nameTest")) || void 0 === r
                ? void 0
                : r.textContent;
            if (!e) return;
            return new g({ name: e, value: a });
          }
          return N(e, "contextItemExpr") || x(e, "textTest")
            ? new d(a)
            : void 0;
        }
      },
      ...
      821(e, t, n) {
            ...
            o = (function* (e, t, n, r, o, a) {
              for (let s of n)
                s.match &&
                  ...
                  b(e, s.match, t, r, (0, p.mkResolver)(a)) &&
                  (yield s);
            })(
              e.patternMatchCache,
              e.contextItem,
        ...
        function E(e, t, n) {
          if (e.length > 0)
            return (0, l.isNodeGroupArray)(e) ? O(e, t, n) : $(e, t, n);
        }
        function $(e, t, n) {
          let r = 0;
          return e.map(
        ...
        function M(e, t) {
          ...
          ("#current" === o && (o = e.mode),
            $(I(e, r, t.sortKeyComponents, n), e, (e) => {
              S(
                Object.assign(Object.assign({}, e), {
                  mode: o,
                  variableScopes: D(e.variableScopes),
        ...
        function Y(e, t) {
          if ("string" == typeof t.content) {
            ...
            return (1 !== r.length || n || (r = r[0]), j(r, t.as));
          }
