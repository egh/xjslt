(() => {
  var e = {
      ...
      821(e, t, n) {
        ...
        function X(e, t, n) {
          let o = j(t.variableScopes);
          for (let r of e.allowedParams) {
            let e = $(r.name, n);
            void 0 !== e ? L(o, e.name, G(t, e)) : L(o, r.name, G(t, r));
          }
          return e.apply(
        ...
        function D(e) {
          return (
            P.has(e) || P.set(e, (0, i.createTypedValueFactory)(e)),
            P.get(e)
          );
        }
        function M(e, t) {
