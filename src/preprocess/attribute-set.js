(() => {
  var e = {
      ...
      320(e, t, n) {
        ...
        function N(e, t) {
          return v(e) && e.localName === t;
        }
        function b(e, t) {
          for (const n of e.childNodes) if (N(n, t)) return n;
        }
        function y(e, t, n) {
          for (const r of e.childNodes) {
            if (!v(r)) continue;
            if (N(r, t) && (!n || n(r))) return r;
            const e = y(r, t, n);
            if (e) return e;
          }
        }
        function T(e) {
          ...
          return (
            "descendant-or-self" ===
              (null === (t = b(e, "xpathAxis")) || void 0 === t
                ? void 0
                : t.textContent) && !!b(e, "anyKindTest")
          );
        }
        ...
        function E(e, t, n, r) {
          ...
          if (
            ...
            for (const o of e.childNodes) E(o, t, n, r);
          else if ("pathExpr" === s) {
            const o = e.childNodes.filter((e) => N(e, "stepExpr"));
            if (0 === o.length) throw new S();
            for (const e of o.slice(0, -1)) if (!T(e)) throw new S();
            E(o[o.length - 1], t, n, r);
          } else if ("stepExpr" === s) {
            const a =
              null === (o = b(e, "xpathAxis")) || void 0 === o
                ? void 0
                : o.textContent;
        ...
        function R(e, t) {
          ...
          if (s) {
            const e =
              null === (r = b(s, "nameTest")) || void 0 === r
                ? void 0
                : r.textContent;
            if (!e) return;
            return new x(m, { name: e, value: a });
          }
          return b(e, "contextItemExpr") || y(e, "textTest")
            ? new w(m, a)
            : void 0;
        }
      },
      ...
      379(e, t, n) {
        ...
        function N({ prefix: e, localName: t }, n) {
      ...
      821(e, t, n) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.message = function (e, t, n) {
            const r = K(e, t.select || n, (0, p.mkResolver)(t.namespaces));
            if ("yes" === t.terminate) throw new Error(r);
            console.log(r);
          }),
          (t.text = function (e, t, n) {
            e.append(K(e, n, (0, p.mkResolver)(t.namespaces), [""]));
          }),
          (t.variable = function (e, t) {
            A(e.variableScopes, t.name, V(e, t));
          }),
          (t.param = function (e, t) {
            A(e.variableScopes, t.name, e.stylesheetParams[t.name] || V(e, t));
          }),
          (t.extendScope = M),
          (t.wrapValue = L),
          (t.setVariable = A),
          ...
          (t.literalElement = function (e, t, n) {
            let r = k(e, { name: t.name, namespace: t.namespace });
            ...
            o = (function* (e, t, n, r, o, a) {
              for (let s of n)
                s.match &&
                  ...
                  y(e, s.match, t, r, (0, p.mkResolver)(a)) &&
                  (yield s);
            })(
              e.patternMatchCache,
              e.contextItem,
          ...
          return (
            (o =
              "number" === n.dataType
                ...
                : (function (e, t, n, r) {
                    const o = R(t, e, (e) => K(e, n.sortKey, r)),
        ...
        function R(e, t, n) {
          if (e.length > 0)
            return (0, l.isNodeGroupArray)(e) ? j(e, t, n) : O(e, t, n);
        }
        function O(e, t, n) {
          let r = 0;
          return e.map(
        ...
        function $(e, t, n, r) {
          if (n) for (let o of [...n].reverse()) t = E(e, t, o, r);
          return t;
        }
        function P(e, t) {
        ...
        function C(e, t, n) {
          let r = M(t.variableScopes);
          for (let o of e.allowedParams) {
            let e = P(o.name, n);
            void 0 !== e ? A(r, e.name, V(t, e)) : A(r, o.name, V(t, o));
          }
          return e.apply(
        ...
        function X(e, t, n) {
          e.append(
            K(e, t.select || n, (0, p.mkResolver)(t.namespaces), t.separator),
          );
        }
        function M(e) {
        ...
        function D(e) {
          return (
            _.has(e) || _.set(e, (0, i.createTypedValueFactory)(e)),
            _.get(e)
          );
        }
        function L(e, t) {
        ...
        function V(e, t) {
          if ("string" == typeof t.content) {
            ...
            return (1 !== r.length || n || (r = r[0]), L(r, t.as));
          }
