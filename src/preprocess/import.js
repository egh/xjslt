      ...
      821: function (e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.message = function (e, t, n) {
            console.log(z(e, t.select || n, y(t.namespaces))),
              "yes" === t.terminate && process.exit();
          }),
          (t.text = function (e, t, n) {
            e.append(z(e, n, y(t.namespaces), [""]));
          }),
          (t.variable = function (e, t) {
            F(e.variableScopes, t.name, B(e, t));
          }),
          (t.param = function (e, t) {
            F(e.variableScopes, t.name, e.stylesheetParams[t.name] || B(e, t));
          }),
          (t.extendScope = M),
          (t.setVariable = F),
          ...
          (t.processingInstruction = function (e, t, n) {
            const o = G(e, t.name, y(t.namespaces)),
              a = z(e, t.select || n, y(t.namespaces), [""]).trimStart();
            e.append(e.outputDocument.createProcessingInstruction(o, a));
          }),
          (t.comment = function (e, t, n) {
            const o = z(e, t.select || n, y(t.namespaces), [""]);
          ...
          (t.element = function (e, t, n) {
            const o = y(t.namespaces),
              a = G(e, t.name, o),
              r = G(e, t.namespace, o);
            let s = K(e, { name: a, namespace: J(a, y(t.namespaces), r) });
            const c = e.append(s);
            n(
              Object.assign(Object.assign({}, e), {
                variableScopes: M(e.variableScopes),
                ...
                n.test(a.textContent) &&
                  (function (e, t) {
                    ...
                    for (const o of t) {
                      ...
                      if (T(n, o.match, null, e, [], t)) return !o.preserve;
                    }
                    return !1;
                  })(a.parentNode, t) &&
                  o.push(a);
        ...
        const P = String.raw`[^,:\(\)\*\[\]/]`,
          ...
          I = String.raw`(document-node\()?`,
          X = new Map([
            [new RegExp(String.raw`^\s*/\s*$`), -0.5],
            [new RegExp(String.raw`^\s*\*\s*$`), -0.5],
            [new RegExp(String.raw`^\s*${I}${N}processing-instruction`), 0],
            [new RegExp(String.raw`^\s*${I}${N}element\(\*?\)\)?\s*$`), -0.5],
            [new RegExp(String.raw`^\s*${I}${N}attribute\(\*?\)\)?\s*$`), -0.5],
            [new RegExp(String.raw`^\s*${I}${N}element\(${P}+\)\)?\s*$`), 0],
            [
              new RegExp(String.raw`^\s*${I}${N}element\(\*,\s*${P}+\)\)?\s*$`),
              0,
            ],
            [new RegExp(String.raw`^\s*${I}${N}attribute\(${P}+\)\)?\s*$`), 0],
            [
              new RegExp(
                String.raw`^\s*${I}${N}attribute\(\*,\s*${P}+\)\)?\s*$`,
              ),
              0,
            ],
            [
              new RegExp(
                String.raw`^\s*${I}${N}element\(${P}+,\s*${P}+\)\)?\s*$`,
              ),
              0.25,
            ],
            [
              new RegExp(
                String.raw`^\s*${I}${N}attribute\(${P}+,\s*${P}+\)\)?\s*$`,
              ),
              0.25,
            ],
            [
              new RegExp(
                String.raw`^\s*${I}${N}schema-element\(${P}+\)\)?\s*$`,
              ),
              0.25,
            ],
            [
              new RegExp(
                String.raw`^\s*${I}${N}schema-attribute\(${P}+\)\)?\s*$`,
              ),
              0.25,
            ],
          ...
          let o = (function* (e, t, n, o, a, r) {
            for (let s of n)
              s.match &&
                ...
                T(e, s.match, s.matchFunction, t, o, y(r)) &&
                (yield s);
          })(
            e.patternMatchCache,
            e.contextItem,
        ...
        function E(e, t, n) {
          ...
          for (let a of e.allowedParams) {
            let e = j(a.name, n);
            void 0 !== e ? F(o, e.name, B(t, e)) : F(o, a.name, B(t, a));
          }
          return e.apply(
        ...
        function C(e, t, n) {
          e.append(z(e, t.select || n, y(t.namespaces), t.separator));
        }
        function M(e) {
