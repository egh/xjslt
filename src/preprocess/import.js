      ...
      821(e, t, n) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.variable = function (e, t) {
            D(e.variableScopes, t.name, L(e, t));
          }),
          (t.param = function (e, t) {
            D(e.variableScopes, t.name, e.stylesheetParams[t.name] || L(e, t));
          }),
          (t.extendScope = $),
          (t.setVariable = D),
        ...
        function h(e, t, n, o, a, r) {
          ...
          if (
            ...
            !(function (e, t) {
              return (
                (t.nodeType === u.NodeType.ATTRIBUTE && !y.exec(e)) ||
        ...
        function N(e, t, n) {
          ...
          for (let a of e.allowedParams) {
            let e = S(a.name, n);
            void 0 !== e ? D(o, e.name, L(t, e)) : D(o, a.name, L(t, a));
          }
          return e.apply(
        ...
        const I = (0, c.createTypedValueFactory)("xs:numeric*"),
          O = (0, c.createTypedValueFactory)("xs:string*"),
