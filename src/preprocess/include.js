(() => {
  var e = {
      ...
      320(e, t, n) {
        ...
        class y extends N {
          matches(e) {
            return w(this.nodeExtractor(e), (e) => e.nodeType === this.value);
          }
        }
        t.NodeTypeFeature = y;
        class T extends N {
          matches(e) {
            return w(this.nodeExtractor(e), (e) => e.nodeName === this.value);
          }
        }
        t.NodeNameFeature = T;
        class b extends N {
        ...
        function M(e, t, n, r) {
          for (const o of t.childNodes) {
            ...
            if ("equalOp" === t) {
              ...
              (M(e, I(o, "firstOperand"), n, r),
                M(e, I(o, "secondOperand"), n, r));
            }
          }
        }
        function _(e, t, n) {
      ...
      821(e, t, n) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.variable = function (e, t) {
            _(e.variableScopes, t.name, Y(e, t));
          }),
          (t.param = function (e, t) {
            _(e.variableScopes, t.name, e.stylesheetParams[t.name] || Y(e, t));
          }),
          (t.extendScope = j),
          (t.wrapValue = M),
          (t.setVariable = _),
        ...
        function C(e, t, n) {
          ...
          for (let o of e.allowedParams) {
            let e = O(o.name, n);
            void 0 !== e ? _(r, e.name, Y(t, e)) : _(r, o.name, Y(t, o));
          }
          return e.apply(
