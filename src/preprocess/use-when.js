          ...
          let r = new Map(),
            ...
            i = {
              ...
              templates: [
                ...
                {
                  match: { xpath: "xsl:*[@use-when]", compiled: void 0 },
                  name: void 0,
                  modes: ["#default"],
                  allowedParams: [],
                  apply: (e) => {
      ...
      821(e, t, n) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.variable = function (e, t) {
            j(e.variableScopes, t.name, G(e, t));
          }),
          (t.param = function (e, t) {
            j(e.variableScopes, t.name, e.stylesheetParams[t.name] || G(e, t));
          }),
          (t.extendScope = P),
          (t.wrapValue = O),
          (t.setVariable = j),
          ...
          let o = (function* (e, t, n, o, r, a) {
            for (let s of n)
              s.match &&
                ...
                N(e, s.match, t, o, (0, p.mkResolver)(a)) &&
                (yield s);
          })(
            e.patternMatchCache,
            e.contextItem,
        ...
        function R(e, t, n) {
          if (e.length > 0)
            return (0, l.isNodeGroupArray)(e) ? b(e, t, n) : y(e, t, n);
        }
        function y(e, t, n) {
          let o = 0;
          return e.map(
        ...
        function I(e, t, n) {
          ...
          for (let r of e.allowedParams) {
            let e = $(r.name, n);
            void 0 !== e ? j(o, e.name, G(t, e)) : j(o, r.name, G(t, r));
          }
          return e.apply(
