            ...
            i = {
                ...
                },
                {
                  ...
                  apply: (e) => {
                    r.ifX(
                      e,
                      {
                        test: "xjslt:evaluate(@xsl:use-when)",
                        namespaces: {
                          xsl: "http://www.w3.org/1999/XSL/Transform",
                          xjslt: "https://www.e6h.org/xjslt",
                        },
              ...
              nonRuleTemplateIndexes: [
                [
                  {
                    xpath:
                      "*[namespace-uri() != 'http://www.w3.org/1999/XSL/Transform' and @xsl:use-when]",
                    compiled: void 0,
                  },
                  5,
                ],
                [{ xpath: "xsl:*[@use-when]", compiled: void 0 }, 4],
                [
                  {
                    xpath: "node()",
      ...
      320(e, t, n) {
        ...
        function D(e, t, n, r) {
          ...
          for (const o of t.childNodes.slice(1)) {
            if (!R(o)) continue;
            const i = o.localName;
            if ("nameTest" === i) (X(e, t, n, r), j(e, s, n));
            else if ("Wildcard" === i) {
              const t = P(o, "NCName");
              if (t) {
                const o =
          ...
          for (const o of t.childNodes) {
            ...
            if ("equalOp" === t) {
              const t = P(o, "firstOperand"),
                r = P(o, "secondOperand");
              if (!t || !r) throw new O();
              const a = _(e, t, r) || _(e, r, t);
              if (!a) throw new O();
              n.push(a);
            } else {
              if ("andOp" !== t) throw new O();
              (M(e, P(o, "firstOperand"), n, r),
                M(e, P(o, "secondOperand"), n, r));
            }
          }
        }
        function _(e, t, n) {
      ...
      821(e, t, n) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.applyTemplates = function (e, t) {
            ...
            ("#current" === o && (o = e.mode),
              P(
                ...
                (e) => {
                  ((e.variableScopes = j(e.variableScopes)),
          ...
          (t.variable = function (e, t) {
            _(e.variableScopes, t.name, B(e, t));
          }),
          (t.param = function (e, t) {
            _(e.variableScopes, t.name, e.stylesheetParams[t.name] || B(e, t));
          }),
          (t.extendScope = j),
          (t.wrapValue = M),
          (t.setVariable = _),
        ...
        function C(e, t, n) {
          let r = j(t.variableScopes);
          for (let o of e.allowedParams) {
            let e = O(o.name, n);
            void 0 !== e ? _(r, e.name, B(t, e)) : _(r, o.name, B(t, o));
          }
          return e.apply(
