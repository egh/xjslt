      ...
      320(e, t, n) {
        ...
        function E(e, t, n, r) {
          ...
          if (
            ...
            const o = e.childNodes.filter((e) => y(e, "stepExpr"));
            if (0 === o.length) throw new S();
            for (const e of o.slice(0, -1)) if (!w(e)) throw new S();
          ...
          if (s) {
            const e =
              null === (r = b(s, "nameTest")) || void 0 === r
                ...
                : r.textContent;
            if (!e) return;
            return new N(m, { name: e, value: a });
          }
          return b(e, "contextItemExpr") || T(e, "textTest")
            ? new v(m, a)
            : void 0;
        }
      },
      ...
      821(e, t, n) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.literalElement = function (e, t, n) {
            ...
            n(
              Object.assign(Object.assign({}, e), {
                variableScopes: _(e.variableScopes),
                append: a || e.append,
              }),
            );
          }),
          ...
          return !(
            ...
            (function (e, t) {
              return (
                ...
                !(!x.exec(e) || t.nodeType === l.NodeType.ATTRIBUTE)
              );
            })(t.xpath, n) ||
            (!(function (e, t) {
              return "text()|@*" === e
          ...
          return (
            (o =
              "number" === n.dataType
                ...
                : (function (e, t, n, r) {
                    const o = R(t, e, (e) => V(e, n.sortKey, r)),
        ...
        function $(e, t, n) {
          ...
          return e.map((e) => {
            ...
            const o = Object.assign(Object.assign({}, t), {
              ...
              currentGroup: e,
              position: r,
              variableScopes: _(t.variableScopes),
            });
            return n(o);
          });
        }
        ...
        function C(e, t, n) {
          ...
          for (let o of e.allowedParams) {
            let e = P(o.name, n);
            void 0 !== e ? U(r, e.name, Y(t, e)) : U(r, o.name, Y(t, o));
          }
          return e.apply(
        ...
        function A(e, t) {
          if (Array.isArray(e) && 0 === e.length) return j("item()*")([], null);
          if (t)
            try {
              return j(t)(e, null);
            } catch (e) {}
        ...
        function Y(e, t) {
          if ("string" == typeof t.content) {
            ...
            return (1 !== r.length || n || (r = r[0]), A(r, t.as));
          }
