          ...
          let r = new Map(),
            ...
            i = {
              ...
              nonRuleTemplateIndexes: [
                [{ xpath: "comment()", compiled: void 0 }, 4],
                [{ xpath: "processing-instruction()", compiled: void 0 }, 4],
                [
                  {
                    xpath: "/",
      ...
      320(e, t, n) {
        ...
        function E(e, t, n, o) {
          ...
          if (
            ...
            for (const e of r.slice(0, -1)) if (!w(e)) throw new S();
            E(r[r.length - 1], t, n, o);
          } else if ("stepExpr" === s) {
            const a =
              null === (r = y(e, "xpathAxis")) || void 0 === r
                ? void 0
                : r.textContent;
        ...
        function R(e, t) {
          ...
          return y(e, "contextItemExpr") || b(e, "textTest")
            ? new x(m, a)
            : void 0;
        }
      },
      ...
      821(e, t, n) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.variable = function (e, t) {
            A(e.variableScopes, t.name, J(e, t));
          }),
          (t.param = function (e, t) {
            A(e.variableScopes, t.name, e.stylesheetParams[t.name] || J(e, t));
          }),
          (t.extendScope = M),
          (t.wrapValue = L),
          (t.setVariable = A),
          (t.mergeVariableScopes = j),
                ...
                n.test(r.textContent) &&
                  (function (e, t) {
                    ...
                    for (const o of t) {
                      ...
                      if (b(n, o.match, e, [], t)) return !o.preserve;
                    }
                    return !1;
                  })(r.parentNode, t) &&
                  o.push(r);
          ...
          return !(
            ...
            (function (e, t) {
              return (
                ...
                (t.nodeType === l.NodeType.TEXT && !T.exec(e)) ||
        ...
        function $(e, t, n) {
          ...
          for (let r of e.allowedParams) {
            let e = P(r.name, n);
            void 0 !== e ? A(o, e.name, J(t, e)) : A(o, r.name, J(t, r));
          }
          return e.apply(
